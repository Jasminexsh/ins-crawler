...
# 初始化参数request
init_params_request = requests.get(user_profile_url, headers=headers)
# 初始化参数json
init_params_datas_json = init_params_request.json()

num = 12
user_id = init_params_datas_json['data']['user']['id']
init_param = init_params_datas_json['data']['user']['edge_owner_to_timeline_media']['edges'][11]['node']['id']
max_id = init_param + '_' + user_id

# 资源路径
resources_path_dir = 'pictures/{}/'.format(username)
# 资源列表路径
...
first_12_items = first_12_url_request.json()['items']
